    ...
    staff.forEach(s => {
        ...
        staffBlock.push({staff: s, block: (
            <div className= "border border-white p-4 mb-4 bg-secondary rounded" key={s._id}>
                ...
                <div className="modal fade" id="absenceModal" tabIndex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            <div className="modal-header">
                            ...
                            <div className="modal-body text-black text-right">
                                ...
                                <div className="row">
                                    ...
                                    <div className={"col"}>
                                        {/*<input type="text" id="edit-staff-disc" onChange={e => setDscUser(e.target.value)} />*/}
                                        <select className="w-75 custom-select" onChange={e => setLeaveType(e.target.value)}>
                                ...
                                <div className="row">
                                    ...
                                    <div className={"col"}>
                                        <input type="date" id="edit-staff-comments" className="w-75" onChange={e => setUntilDate(e.target.value)} />
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col">
                                    ...
                                    <div className={"col"}>
                                        <input type="text" id="edit-staff-email" onChange={e => setReason(e.target.value)} />
                                    </div>
                                </div>
                                <hr />
                                <p className="text-center"><strong>Contact @develop331 to edit other fields.</strong></p>
                            ...
                            <div className="modal-footer">
                                <button type="button" className="btn btn-secondary" data-dismiss="modal">Close</button>
                                <button type="button" className="btn btn-danger" onClick={applyAbsence}>Save changes</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="modal fade" id="removeModal" tabIndex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title text-black" id="exampleModalLabel">Cancel absence: Are you sure?</h5>
                                <button type="button" className="btn bg-white text-black" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div className="modal-footer">
                                ...
                                <button type="button" className="btn btn-danger" onClick={removeAbsence}>Yes</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="container justify-content-center align-self-center">
                            <div className="row">
                                <button className="m-1 col-1 btn border border-black text-black" data-toggle="modal" data-target="#editModal" id="editButton" onClick={() => setRblxUser(s.rblx)}>Edit</button>
                                <button className="m-1 col-2 btn border border-black text-black" data-toggle="modal" data-target="#absenceModal" id="absenceButton" onClick={() => setRblxUser(s.rblx)}>Apply absence</button>
                                <button className="m-1 col-2 btn border border-black text-black" data-toggle="modal" data-target="#removeModal" id="absenceButton" onClick={() => setRblxUser(s.rblx)}>Remove absence</button>
                            </div>
                        </div>
                    </div>
                </div>
