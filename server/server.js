...
app.post('/rpc/assignTask', RateLimitDefault, Authorize, async (req, res) => {
    ...
    await con.post("notifs", [{user: new ObjectId(req.body.recipient), ack: 0, title: "Developer Tasks", desc: `You have been set a new developer task with title ${req.body.title}. It is due ${req.body.date}.`}])
    res.send()
})
